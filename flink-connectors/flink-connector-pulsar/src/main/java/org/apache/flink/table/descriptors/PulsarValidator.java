...
public class PulsarValidator extends ConnectorDescriptorValidator {
    ...
    private void validateStartupMode(DescriptorProperties properties) {
        ...
        startupModeValidation.put(CONNECTOR_STARTUP_MODE_VALUE_SPECIFIC_OFFSETS,
                key -> properties.validateFixedIndexedProperties(CONNECTOR_SPECIFIC_OFFSETS,
                        false, specificOffsetValidators));
        startupModeValidation.put(CONNECTOR_STARTUP_MODE_VALUE_EXTERNAL_SUB,
