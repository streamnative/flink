...
public class PulsarSourceOptions {
    ...
    public static final ConfigOption<Long> MAX_FETCH_TIME =
            ConfigOptions.key("max.fetch.time")
                    .longType()
                    .defaultValue(500L)
                    .withDescription(
    ...
    public static final ConfigOption<Integer> MAX_FETCH_RECORDS =
            ConfigOptions.key("max.fetch.records")
                    .intType()
                    .defaultValue(100)
                    .withDescription(
    ...
    public static final ConfigOption<OffsetVerification> VERIFY_INITIAL_OFFSETS =
            ConfigOptions.key("verify.initial.offsets")
