...
public class PulsarSourceEnumStateSerializer
    ...
    private static final PulsarPartitionSplitSerializer SPLIT_SERIALIZER = new PulsarPartitionSplitSerializer();
    ...
    public PulsarSourceEnumState deserialize(int version, byte[] serialized) throws IOException {
        ...
        try (ByteArrayInputStream bais = new ByteArrayInputStream(serialized);
            ...
            Set<TopicPartition> partitions = PulsarSerdeUtils.deserializeSet(
                    in,
                    bytes -> SPLIT_SERIALIZER.deserializeTopicPartition(version, bytes));
            Set<PulsarPartitionSplit> splits = PulsarSerdeUtils.deserializeSet(
                    in,
                    bytes -> SPLIT_SERIALIZER.deserialize(version, bytes));
