...
/**
 * Test for {@link PulsarTableOptions}.
 */
public class PulsarOptionsTest {

	@Test
	public void testFormatProjection() {
		final TableSchema schema = TableSchema.builder()
				.add(TableColumn.physical("id", DataTypes.INT()))
				.add(TableColumn.metadata("eventTime", DataTypes.TIMESTAMP(3)))
				.add(TableColumn.computed("timestamp_converted", DataTypes.STRING(), "CAST(`eventTime` AS STRING)"))
